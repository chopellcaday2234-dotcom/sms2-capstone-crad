...
$studentResearchDevelopmentItems = [
    ...
    ['slug' => 'final-manuscript',  'href' => BASE_URL . '/modules/student-portal/pages/final-manuscript.php',  'icon' => 'fa-file-signature',  'label' => 'Final Documentation',  'locked' => false],
];
...
if (!isset($facultyAccountNavGroups['Research Monitoring'])) {
    $facultyAccountNavGroups['Research Monitoring'] = [
        ...
        ['slug' => 'final-draft-review', 'href' => BASE_URL . '/modules/faculty/pages/final-draft-review.php', 'icon' => 'fa-file-alt', 'label' => 'Final Draft Review'],
