...
function smsResearchCoordinatorCradModule(): array
{
    return [
        ...
        'pages' => [
            ...
            ['slug' => 'semester-transition', 'title' => 'Second Semester Transition'],
            ['slug' => 'final-defense-readiness', 'title' => 'Final Defense Readiness'],
...
function requireModuleAccess(string $moduleKey): void
{
    ...
    if ($key === 'crad' && getCurrentUserRoleKey() === 'research_coordinator') {
        $allowedCoordinatorPages = [
            ...
            '/modules/crad/pages/semester-transition.php',
            '/modules/crad/pages/final-defense-readiness.php',
