...
function cradPruneOrphanDefenseSchedules(PDO $pdo): void
{
    ...
    // A defense schedule becomes an academic record once panels/evaluations exist.
    // Never delete it during a page view merely because its original proposal row
    // was superseded by the official research-group registration. Repair the group
    // link when possible and retain unmatched rows for audit/recovery.
    $pdo->exec("
