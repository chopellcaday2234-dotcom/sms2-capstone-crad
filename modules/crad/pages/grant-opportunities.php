...
// Lead proponent pre-fill — use the canonical authenticated display name.
$sessionUserName = trim(function_exists('getCurrentUserName') ? getCurrentUserName() : (string) ($_SESSION['user_name'] ?? ''));
